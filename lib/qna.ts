...
export const CURATED_AEO_QNAS: QnAItem[] = [
    ...
    },
    {
        ...
        answer:
            '가능합니다. WOW3D 자동견적에서 「3D 모델이 없어요」를 선택하고 JPG 또는 PNG 제품 사진을 업로드하면 AI가 3D 메시(STL)를 생성한 뒤 부피·가격 자동견적으로 이어집니다. 정밀 치수·조립 공차가 중요한 부품은 STL 또는 STEP 업로드를 권장합니다.',
        category: 'quote',
        display_order: 9,
    },
    {
    ...
    {
        id: -11,
        question: '사진→AI 3D는 하루에 몇 번 사용할 수 있나요?',
        answer:
    ...
    {
        id: -12,
        question: 'AI 3D Maker와 사진→AI 3D 견적의 차이는 무엇인가요?',
        answer:
            'AI 3D Maker는 스케치·로고 PNG의 2.5D 돌출용이고, 사진→AI 3D 견적은 실사 사진 기반 입체 메시 생성 후 즉시 출력 견적·주문으로 이어집니다.',
        category: 'general',
        display_order: 12,
    },
    {
        id: -13,
        question: '사진→3D와 CAD·STL 업로드 중 무엇을 써야 하나요?',
        answer:
            '조립 공차·정밀 치수가 중요하면 STL 또는 STEP 업로드를 권장합니다. 형상 확인·시제품·피규어 아이디어 검증에는 사진 AI 3D가 적합합니다.',
        category: 'tech',
        display_order: 13,
    },
    {
