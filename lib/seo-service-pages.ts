...
export const SERVICE_LANDINGS: ServiceLandingConfig[] = [
    {
        ...
        title: '3D프린팅 출력대행 | 3D프린터 출력대행 업체',
        h1: '3D프린팅',
        h1Accent: '출력대행',
        description:
            '3D프린팅 출력대행·3D프린터 출력대행이 필요할 때 WOW3D에서 파일 업로드 후 자동견적으로 가격을 확인하고 주문하세요.',
        keywords: ['3D프린팅 출력대행', '3D프린터 출력대행', '3D프린팅 업체'],
