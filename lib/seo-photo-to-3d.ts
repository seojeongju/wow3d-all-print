...
export const PHOTO_TO_3D_GUIDE_TITLE = '사진(이미지)으로 3D 프린팅 견적 받는 방법 | AI 3D 모델링 · 자동견적'
...
export const PHOTO_TO_3D_SHOWCASE: readonly PhotoTo3DShowcaseItem[] = [
    {
        title: '피규어 · 캐릭터 형상 확인',
        caption: '단색 배경 캐릭터 사진(이미지)에서 입체 메시를 생성한 뒤 SLA/DLP로 키캡·피규어 외관 시제품을 출력하는 흐름에 적합합니다.',
    ...
    {
        title: '시제품 · 부품 외관 검증',
        caption: '실물·레퍼런스 사진(이미지)으로 형상을 빠르게 확인하고 FDM·SLA 견적·출력까지 이어지는 사례 유형입니다.',
...
export function buildPhotoTo3DShowcaseSchema(items: readonly PhotoTo3DShowcaseItem[] = PHOTO_TO_3D_SHOWCASE) {
    return {
        ...
        '@type': 'ItemList',
        name: '사진(이미지)→AI 3D 변환·출력 사례',
        description: '제품 사진(이미지)에서 AI 3D 모델을 생성하고 3D 프린팅 출력까지 진행하는 WOW3D 워크플로 예시',
