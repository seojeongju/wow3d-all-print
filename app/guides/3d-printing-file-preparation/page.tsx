...
const faqItems = [
    {
        ...
        a: '일반적으로 STL, OBJ, 3MF가 많이 사용됩니다. 형상 정보만 필요한 경우 STL이 가장 보편적이며, 색상이나 추가 메타데이터가 필요하면 OBJ 또는 3MF가 유리할 수 있습니다.',
    },
    {
    ...
    },
    {
        ...
        a: '프로젝트 성격에 따라 가능하지만, 자동견적과 즉시 분석은 보통 메쉬 기반 파일에서 더 안정적으로 동작합니다. 필요하면 STEP을 STL로 변환해 함께 검토하는 것이 좋습니다.',
    },
];
