...
export async function GET() {
  try {
    ...
    if (!env?.DB) {
      return NextResponse.json({
        ...
        data: {
          ...
          sla: { max: { x: 145, y: 145, z: 175 }, layerHeights: [0.025, 0.05, 0.1], hourlyRate: 11100 },
          dlp: { max: { x: 120, y: 68, z: 200 }, layerHeights: [0.025, 0.05, 0.1], hourlyRate: 7100 },
        },
      })
    }
    ...
    const defaults: Record<string, Spec> = {
      ...
      sla: { max: { x: 145, y: 145, z: 175 }, layerHeights: [0.025, 0.05, 0.1], hourlyRate: 11100, sla_layer_exposure_sec: 9, sla_labor_cost_krw: 10700, sla_consumables_krw: 3900, sla_post_process_krw: 10400 },
      dlp: { max: { x: 120, y: 68, z: 200 }, layerHeights: [0.025, 0.05, 0.1], hourlyRate: 7100, dlp_layer_exposure_sec: 3, dlp_labor_cost_krw: 9100, dlp_consumables_krw: 3900, dlp_post_process_krw: 10400 },
    }
    ...
    for (const r of rows) {
      ...
      const spec: Spec = {
        ...
        sla_layer_exposure_sec: r.sla_layer_exposure_sec ?? 9,
        sla_labor_cost_krw: r.sla_labor_cost_krw ?? 10700,
