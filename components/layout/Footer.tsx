                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        <Link href="/" className="flex items-center gap-2.5 group transition-all">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center shadow-lg shadow-teal-500/20 group-hover:shadow-teal-500/40 transition-all">
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            {[
                                ...
                                <a key={i} href={url} target="_blank" rel="noopener noreferrer" aria-label={name} title={name} className="w-10 h-10 rounded-xl bg-white/[0.05] border border-white/10 flex items-center justify-center text-white/30 hover:text-teal-400 hover:border-teal-500/30 hover:bg-teal-500/10 transition-all hover:-translate-y-1">
                    ...
                    <div className="lg:col-span-5 grid grid-cols-2 gap-8">
                        <div className="space-y-6">
                            <h3 className="text-[10px] font-black uppercase text-teal-400 tracking-[0.3em]">제작 센터</h3>
                            <ul className="space-y-4">
                                {[
                                    ...
                                    <li key={item.name} className="group cursor-pointer">
                                        <div className="text-[11px] font-black text-white/50 group-hover:text-teal-400 transition-colors flex items-center gap-1.5">
                                            {item.name}
                                        ...
                                        <p className="text-[10px] text-white/25 mt-1 font-medium">{item.address}</p>
                                    </li>
                                ))}
                            </ul>
                        </div>
                        <div className="space-y-6">
                            ...
                            <ul className="space-y-4">
                                <li>
                                    <div className="text-[11px] font-black text-white/50 uppercase tracking-widest mb-1.5">대표 전화</div>
                                    <p className="text-[10px] text-white/30 font-bold">02-3144-3137</p>
                                    <p className="text-[10px] text-white/30 font-bold">054-464-3144</p>
                                </li>
                                <li>
                                    <div className="text-[11px] font-black text-white/50 uppercase tracking-widest mb-1.5">이메일 문의</div>
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        <div className="p-6 rounded-3xl bg-white/[0.03] border border-white/8">
                            <h3 className="text-xs font-black uppercase tracking-widest mb-4 text-white/70">소식 받기</h3>
                            <p className="text-[10px] text-white/25 font-medium mb-4 italic">적층 제조 워크숍·신규 소재 소식을 가장 먼저 받아보세요.</p>
                            <div className="flex gap-2">
                                <input
                                    type="email"
                                    placeholder="이메일 주소"
                                    className="flex-1 h-10 bg-white/5 border border-white/10 rounded-xl px-3 text-xs font-bold text-white placeholder:text-white/20 focus:outline-none focus:ring-1 focus:ring-teal-400 transition-all"
                                />
                                <button className="w-10 h-10 rounded-xl bg-teal-500 flex items-center justify-center text-white hover:bg-teal-400 transition-all">
