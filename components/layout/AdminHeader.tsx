                    ...
                    <AnimatePresence>
                        {mobileOpen && (
                            <motion.div
                                ...
                                className="fixed inset-0 z-[200] md:hidden bg-[#0a0a0a]"
                                role="dialog"
                                aria-modal="true"
                                aria-label="관리자 메뉴"
                            >
                                ...
                                >
                                    <div className="flex items-center justify-between mb-4">
                                        <p className="text-[10px] font-black text-white/35 uppercase tracking-[0.25em]">Quick Menu</p>
                                        <button
                                            type="button"
                                            onClick={() => setMobileOpen(false)}
                                            className="w-10 h-10 rounded-xl border border-white/10 bg-[#141414] flex items-center justify-center text-white/70 hover:text-white hover:bg-white/10 transition-colors md:hidden"
                                            aria-label="메뉴 닫기"
                                        >
                                            <X className="w-5 h-5" />
                                        </button>
                                    ...
                                    <div className="flex items-center gap-4 px-4 py-5 rounded-2xl bg-[#141414] border border-white/10 mb-5 shadow-lg shadow-black/40">
                                        ...
                                        <div className="flex flex-col min-w-0">
                                            <p className="font-black text-white text-base tracking-tight truncate">{user?.name || '관리자'}</p>
                                            <p className="text-[10px] text-white/50 uppercase font-black tracking-widest mt-0.5">Administrator</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        <Link
                                            href="/"
                                            onClick={() => setMobileOpen(false)}
                                            className="flex items-center gap-4 px-4 py-4 rounded-2xl text-white bg-[#141414] border border-white/10 hover:border-white/20 hover:bg-[#1a1a1a] transition-all min-h-[56px] font-bold text-sm shadow-md shadow-black/30"
                                        >
                                        ...
                                        <Link
                                            href="/quote"
                                            onClick={() => setMobileOpen(false)}
                                            className="flex items-center gap-4 px-4 py-4 rounded-2xl text-teal-300 bg-teal-500/10 border border-teal-500/25 hover:bg-teal-500/15 transition-all min-h-[56px] font-bold text-sm shadow-md shadow-black/30"
                                        >
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-4 px-4 py-4 rounded-2xl text-red-400 bg-red-500/10 border border-red-500/20 hover:bg-red-500/15 transition-all min-h-[60px] w-full text-left font-black text-sm"
                                    >
